      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto p-4 flex justify-between items-center">
          <div className="flex items-center gap-3 min-w-0">
            <div className="h-11 w-11 rounded-[14px] bg-white border-2 border-[#0E9F6E] p-1.5 shadow-sm flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[10px] font-bold text-[#0E9F6E] tracking-widest uppercase truncate">Hospitality Operations Manager</div>
            </div>
          </div>
          <a href="/dashboard" className="bg-[#0E1A14] text-white px-5 sm:px-6 py-2.5 rounded-full font-bold text-sm shrink-0">Open OS</a>
        </div>
      </header>
      <section className="max-w-7xl mx-auto px-5 sm:px-6 py-14 md:py-24 grid md:grid-cols-2 gap-10 md:gap-12 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            <a href="/dashboard" className="bg-[#0E9F6E] text-white px-8 py-3.5 rounded-full font-black text-center">Launch Dashboard</a>
            <a href="https://hexadigitall.com" className="border px-8 py-3.5 rounded-full font-bold text-center">By Hexadigitall</a>
          </div>
        </div>
        <div className="bg-[#0E1A14] rounded-[2rem] sm:rounded-[2.5rem] p-3 shadow-2xl max-w-md w-full mx-auto">
