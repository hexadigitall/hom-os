...
class _TaxScreenState extends State<TaxScreen> {
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 16),
              TextField(controller: nameCtl, decoration: const InputDecoration(labelText: 'State Name')),
              const SizedBox(height: 12),
              TextField(controller: rateCtl, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Tax Rate (%)', hintText: 'e.g. 5.0')),
              const SizedBox(height: 12),
              CheckboxListTile(
                title: const Text('Applies to Accommodation', style: TextStyle(fontSize: 13)),
                value: acc,
              ...
              CheckboxListTile(
                title: const Text('Applies to Food & Drinks', style: TextStyle(fontSize: 13)),
                value: food,
              ...
              CheckboxListTile(
                title: const Text('Applies to Other Services', style: TextStyle(fontSize: 13)),
                value: other,
              ...
              SizedBox(
                ...
                child: RoleGate(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final rate = double.tryParse(rateCtl.text) ?? 5.0;
                      if (nameCtl.text.isEmpty) return;
                      ComplianceStore.upsertTaxConfig(StateTaxConfig(
                        stateName: nameCtl.text, rate: rate,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        Text('Configured States', style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
        const SizedBox(height: 8),
        ...configs.map((c) => Card(
          margin: const EdgeInsets.only(bottom: 8),
          child: ListTile(
            title: Text(c.stateName, style: const TextStyle(fontWeight: FontWeight.w700)),
        ...
        SizedBox(
          ...
          child: RoleGate(
            ...
            child: OutlinedButton.icon(
              onPressed: () => _editConfig(StateTaxConfig(stateName: '', rate: 5.0)),
        ...
        Text('Tax Reports', style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
        const SizedBox(height: 8),
        if (reports.isEmpty)
          Center(
            child: Padding(
          ...
          ...reports.map((r) => Card(
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Flexible(child: Text('${r.stateName} — ${DateFormat('MMM yyyy').format(r.periodStart)}', style: const TextStyle(fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)),
  ...
  Widget _statusChip(String s) {
    ...
    return Container(
      ...
      child: Text(s.toUpperCase(), style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: c)),
    );
  }
