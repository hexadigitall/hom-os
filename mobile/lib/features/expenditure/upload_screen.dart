...
class _UploadScreenState extends State<UploadScreen> {
  bool _loading = false;
  String? _status;
  Color _statusColor = AppColors.grey500;
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        Card(
          child: Padding(
            ...
            child: Column(children: [
              Icon(Icons.cloud_upload_rounded, size: 64, color: AppColors.grey400),
              const SizedBox(height: 12),
              const Text('Upload Expenditure Data', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
              const SizedBox(height: 8),
              Text('Accepted formats: CSV, XLSX', style: TextStyle(color: AppColors.grey600, fontSize: 13)),
              const SizedBox(height: 8),
              Text('See Format Guide for the required column structure', style: TextStyle(color: AppColors.grey500, fontSize: 12)),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Icon(_statusColor == AppColors.green ? Icons.check_circle : _statusColor == AppColors.red ? Icons.error : Icons.info,
        ...
        if (ExpenditureStore.count > 0)
          Text('Total: ${_fmt(ExpenditureStore.totalAll)}', style: TextStyle(color: AppColors.grey600, fontSize: 13)),
      ]),
    );
  }
